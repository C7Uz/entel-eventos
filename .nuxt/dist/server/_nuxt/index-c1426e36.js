    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(eventModule).event) {
        ...
        if (unref(isLoading)) {
          ...
          _push(`<span data-v-2a1c2572>Enviar inscripción</span>`);
        }
...
const index_vue_vue_type_style_index_0_scoped_2a1c2572_lang = "";
...
//# sourceMappingURL=index-c1426e36.js.map
