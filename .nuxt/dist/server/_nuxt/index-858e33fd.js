...
import "axios";
const _imports_3 = "" + __buildAssetsURL("alert.1b6de979.svg");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(eventModule).event) {
        ...
        if (unref(isLoading)) {
          ...
          _push(`<span data-v-7fec544f>Enviar inscripción</span>`);
        }
...
const index_vue_vue_type_style_index_0_scoped_7fec544f_lang = "";
...
//# sourceMappingURL=index-858e33fd.js.map
