...
import "axios";
const _imports_1 = "" + __buildAssetsURL("logoempower.25426229.svg");
const index_vue_vue_type_style_index_0_scoped_f9ada304_lang = "";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></article></div></div><div class="min-w-50 w-1/2 mt-6" data-v-f9ada304><div class="flex pr-4" data-v-f9ada304><article class="wdt-t items-center justify-center fondo-rutas min-h-128 flex flex-col lg:flex-row box-shadow-default w-full relative overflow-hidden bg-gray rounded-2xl" data-v-f9ada304><div class="items-center justify-center" data-v-f9ada304><h2 class="text-entel-ruta" data-v-f9ada304>La Ruta Entel<br data-v-f9ada304>Empresas</h2><p class="sub-text-entel-ruta" data-v-f9ada304>¡Contenido de valor para potenciar tu empresa!</p><div class="flex items-center justify-center gap-x-2 text-primary mt-2" data-v-f9ada304>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "w-full bg-primary text-white text-center font-medium py-2.5 px-16 text-base hover:text-white mt-8 rounded-full text-l flex items-center justify-center whitespace-nowrap md:width-peque-button max-w-full hover:bg-primary-hover active:bg-primary-pressed focus:bg-primary-pressed"
  }, {
  ...
  _push(`</div></div></article></div><div style="${ssrRenderStyle({ "width": "80vw" })}" class="swiper-slide" data-v-f9ada304><article class="items-center justify-center fondo-rutas min-h-64 flex flex-col lg:flex-row box-shadow-default w-full relative overflow-hidden bg-gray rounded-2xl" data-v-f9ada304><div class="items-center justify-center" data-v-f9ada304><h2 class="text-entel-ruta" data-v-f9ada304>La Ruta Entel<br data-v-f9ada304>Empresas</h2><p class="sub-text-entel-ruta" data-v-f9ada304>¡Contenido de valor para potenciar tu empresa!</p><div class="flex items-center justify-center gap-x-2 text-primary mt-2" data-v-f9ada304>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "w-full bg-primary text-white text-center font-medium py-2.5 px-16 text-base hover:text-white mt-8 rounded-full text-l flex items-center justify-center whitespace-nowrap md:width-peque-button max-w-full hover:bg-primary-hover active:bg-primary-pressed focus:bg-primary-pressed"
  }, {
...
//# sourceMappingURL=index-c1632675.js.map
