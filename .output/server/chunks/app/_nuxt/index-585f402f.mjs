...
import { p as provideApi } from './useApi-aa853999.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></section><main class="bg-white py-12" id="events" data-v-c1e1b26b><div class="container flex flex-col" data-v-c1e1b26b><h2 class="text-black font-medium text-2xl lg:text-3-5xl" data-v-c1e1b26b>Pr\xF3ximos eventos</h2></div><div class="container hidden md:flex flex-wrap sm-pr-0" style="${ssrRenderStyle({ "padding-right": ".5rem" })}" data-v-c1e1b26b>`);
...
//# sourceMappingURL=index-585f402f.mjs.map
