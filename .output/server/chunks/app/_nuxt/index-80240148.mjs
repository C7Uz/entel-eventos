    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(eventModule).event) {
        ...
        if (unref(isLoading)) {
          ...
          _push(`<span data-v-83c90378>Enviar inscripci\xF3n</span>`);
        }
...
//# sourceMappingURL=index-80240148.mjs.map
