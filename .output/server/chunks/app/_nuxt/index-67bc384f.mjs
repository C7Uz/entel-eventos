...
const _imports_1 = "" + buildAssetsURL("arrow_right.c2854c0d.svg");
    ...
    return {
      ...
      agendaItems: [
        ...
        },
        {
          ...
          description: "Cu\xE1l es el impacto de la digitalizaci\xF3n en la econom\xEDa empresarial peruana, identificando tendencias, desaf\xEDos y oportunidades que enfrentan las empresas al adoptar tecnolog\xEDas digitales y c\xF3mo esto transforma sectores clave para impulsar el crecimiento y la eficiencia en los negocios.",
          speaker: {
            name: "Iv\xE1n Portocaero",
            foto: "../assets/img/expositores/ivan_portocarrero.png",
            title: "Director de An\xE1lisis Estrat\xE9gico del Sector de Energ\xEDa y Telecomunicaciones"
          }
        },
        {
          id: 4,
          ...
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "C\xF3mo la Inteligencia Artificial est\xE1 siendo la ser una promesa futura para convertirse en una herramienta concreta en la forma de decisiones, la productividad y la innovaci\xF3n.",
          speaker: {
            name: "Raul Campos",
        ...
        },
        {
          ...
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "C\xF3mo la Plataforma OPTI ONE permite que las organizaciones optimicen de forma centralizada sus capacidades \xFAnicas transformando la productividad y liderando el cambio. Mejorando las operaciones del negocio, aumentando la productividad y fortaleciendo la seguridad.",
          speaker: {
            name: "Jos\xE9 Antonio Mart\xEDnez",
        ...
        },
        {
          ...
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "La evoluci\xF3n de la seguridad perimetral hacia SASE marca un cambio fundamental en seguridad y conectividad en la nube con inteligencia artificial para anticipar amenazas. Esto permite una protecci\xF3n m\xE1s \xE1gil y coherente en el entorno digital actual que se adapta a las necesidades empresariales actuales y futuras con una experiencia continua e inteligente.",
          speaker: {
            name: "Tom\xE1s Azmat",
            foto: "../assets/img/expositores/jose_antonio_martinez.png",
        ...
        },
        {
          ...
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "C\xF3mo la IA conversacional est\xE1 cambiando la forma en que las empresas gestionan la relaci\xF3n con sus clientes. Ofrecemos soluciones de vanguardia que permiten a las organizaciones brindar un servicio personalizado y eficiente a trav\xE9s de canales digitales que se conectan.",
          speaker: {
        ...
        },
        {
          id: 9,
          time: "2:00 pm",
          title: "Haz Acti tu Antivirus: C\xF3mo Modernizar la Gesti\xF3n y Seguridad de TI con Acronis",
          tag: "Acronis",
          expandable: true,
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "Descubre c\xF3mo modernizar la seguridad de TI con Acronis, integrando protecci\xF3n avanzada, automatizaci\xF3n y gesti\xF3n simplificada para enfrentar las amenazas actuales de manera eficaz.",
          speaker: {
        ...
        },
        {
          id: 10,
          time: "2:40 pm",
          title: "Innovaci\xF3n sin L\xEDmites: El Enfoque APM para la Transformaci\xF3n de Negocios",
          tag: "Atlassian Web Services",
          expandable: true,
          expanded: false,
          image: "../assets/img/icons/speaker.png",
          description: "Explora la innovaci\xF3n con nuestras soluciones avanzadas que potencian empresas a trav\xE9s del Application Performance Monitoring (APM). Descubre c\xF3mo nuestras herramientas transforman los procesos empresariales, optimizan la experiencia del cliente e impulsan la transformaci\xF3n digital y la innovaci\xF3n en cada proyecto de negocios.",
          speaker: {
            name: "Diego Silva",
...
//# sourceMappingURL=index-67bc384f.mjs.map
