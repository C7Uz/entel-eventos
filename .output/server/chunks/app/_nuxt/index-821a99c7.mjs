...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></article></div></div><div class="min-w-50 w-1/2 mt-6" data-v-fd328c35><div class="flex pr-4" data-v-fd328c35><article class="wdt-t items-center justify-center fondo-rutas min-h-128 flex flex-col lg:flex-row box-shadow-default w-full relative overflow-hidden bg-gray rounded-2xl" data-v-fd328c35><div class="items-center justify-center m-w-300" data-v-fd328c35><h2 class="text-entel-ruta" data-v-fd328c35>La Ruta Entel<br data-v-fd328c35>Empresas</h2><br data-v-fd328c35><p class="sub-text-entel-ruta" data-v-fd328c35>\xA1Contenido de valor para potenciar tu empresa!</p><div class="flex items-center justify-center gap-x-2 text-primary mt-2" data-v-fd328c35>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "w-full bg-primary text-white text-center font-medium py-2.5 px-16 text-base hover:text-white mt-8 rounded-full text-l flex items-center justify-center whitespace-nowrap md:width-peque-button max-w-full hover:bg-primary-hover active:bg-primary-pressed focus:bg-primary-pressed"
  }, {
  ...
  _push(`</div></div></article></div><div style="${ssrRenderStyle({ "width": "80vw" })}" class="swiper-slide" data-v-fd328c35><article class="items-center justify-center fondo-rutas min-h-64 flex flex-col lg:flex-row box-shadow-default w-full relative overflow-hidden bg-gray rounded-2xl" data-v-fd328c35><div class="items-center justify-center" data-v-fd328c35><h2 class="text-entel-ruta" data-v-fd328c35>La Ruta Entel<br data-v-fd328c35>Empresas</h2><p class="sub-text-entel-ruta" data-v-fd328c35>\xA1Contenido de valor para potenciar tu empresa!</p><div class="flex items-center justify-center gap-x-2 text-primary mt-2" data-v-fd328c35>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "w-full bg-primary text-white text-center font-medium py-2.5 px-16 text-base hover:text-white mt-8 rounded-full text-l flex items-center justify-center whitespace-nowrap md:width-peque-button max-w-full hover:bg-primary-hover active:bg-primary-pressed focus:bg-primary-pressed"
  }, {
...
//# sourceMappingURL=index-821a99c7.mjs.map
