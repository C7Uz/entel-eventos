...
import { useSSRContext, defineComponent, withCtx, createVNode, createTextVNode, unref } from 'vue';
...
import { _ as _imports_1 } from './logo-color-8a30c0cd.mjs';
import { _ as _imports_2 } from './edit-c6270b53.mjs';
import { _ as _imports_1$1 } from './empower-logo-8b6cfdfb.mjs';
...
const _imports_4 = "" + buildAssetsURL("arrow_right.c2854c0d.svg");
    ...
    return {
      ...
      agendaItems: [
        ...
        },
        {
          id: 3,
          time: "9:25 am",
          title: "Digitalizaci\xF3n en el mundo de los negocios en Per\xFA",
          tag: "Charla de apertura",
          expandable: true,
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "Cu\xE1l es el impacto de la digitalizaci\xF3n en el entorno empresarial peruano, destacando tendencias, desaf\xEDos y estrategias clave para enfrentar el futuro. Se explorar\xE1n las oportunidades que ofrece la transformaci\xF3n digital para impulsar el crecimiento y la eficiencia en las organizaciones.",
          speaker: {
            name: "Iv\xE1n Portocaero",
            foto: "../../assets/img/expositores/ivan_portocarrero.png",
            title: "Director de an\xE1lisis sectorial y de proyectos del Servicio de Asesor\xEDa Empresarial (SAE)."
          }
        },
        {
          id: 4,
          time: "10:00 am",
          title: "La IA en el negocio, \xBFest\xE1n listos para trabajar con un copilot?",
          tag: "Microsoft",
          expandable: true,
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "C\xF3mo la Inteligencia Artificial est\xE1 dejando de ser una promesa futura para convertirse en una herramienta concreta en la toma de decisiones, la productividad y la innovaci\xF3n.",
          speaker: {
            name: "Raul Campos",
        ...
        },
        {
          ...
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "C\xF3mo la Plataforma SOTI ONE permite que las organizaciones gestionen de forma centralizada sus dispositivos m\xF3viles, aplicaciones y endpoints, optimizando as\xED las operaciones cr\xEDticas del negocio, aumentando la productividad  y fortaleciendo la seguridad.",
          speaker: {
            name: "Jos\xE9 Antonio Martinez",
        ...
        },
        {
          ...
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "La evoluci\xF3n de la seguridad gestionada hacia SASE marca un cambio clave: integrar red y seguridad en la nube con inteligencia artificial para anticipar amenazas. Esto permite una protecci\xF3n m\xE1s \xE1gil y contextual en un entorno digital cada vez m\xE1s distribuido. La seguridad ya no es un per\xEDmetro, es una experiencia continua e inteligente.",
          speaker: {
            name: "Tom\xE1s Asmat",
        ...
        },
        {
          ...
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "C\xF3mo la IA conversacional est\xE1 cambiando la forma en que las empresas gestionan la relaci\xF3n con sus usuarios. Descubre estrategias y soluciones pr\xE1cticas para transformar la forma en que te conectas.",
          speaker: {
            name: "Maurice Falc\xF3n",
        ...
        },
        {
          id: 9,
          time: "11:50 am",
          title: "M\xE1s All\xE1 del Antivirus: C\xF3mo Modernizar la Gesti\xF3n y Seguridad de TI con Acronis",
          tag: "Acronis",
          expandable: true,
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "Descubre c\xF3mo modernizar la seguridad de TI con Acronis, integrando protecci\xF3n avanzada, automatizaci\xF3n y gesti\xF3n centralizada desde una sola consola.",
          speaker: {
            name: "Guillermo M\xE1rquez",
        ...
        },
        {
          id: 10,
          time: "12:10 pm",
          title: "Innovaci\xF3n sin L\xEDmites: El Enfoque AWS para la Transformaci\xF3n de Negocios",
          tag: "Amazon Web Services",
          expandable: true,
          expanded: false,
          image: "../../assets/img/icons/speaker.png",
          description: "Frente a la necesidad creciente de las empresas peruanas por acelerar su transformaci\xF3n digital, exploraremos el enfoque peculiar de AWS, en donde nos enfocamos en los desaf\xEDos empresariales de nuestros clientes para crear soluciones de nube innovadoras, seguras y costo-eficientes que revolucionan los procesos de negocio.",
          speaker: {
            name: "Diego Silva",
            foto: "../../assets/img/expositores/diego_silva.png",
            title: "Territory Manager AWS Per\xFA"
          }
        },
        {
          id: 11,
...
//# sourceMappingURL=index-f7269869.mjs.map
