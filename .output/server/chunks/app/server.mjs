import { version, hasInjectionContext, inject, getCurrentInstance, ref, watchEffect, watch, useSSRContext, createApp, reactive, effectScope, isRef, isReactive, toRaw, unref, getCurrentScope, onScopeDispose, nextTick, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRefs, markRaw, computed, toRef, shallowRef, isReadonly, defineAsyncComponent, isShallow, withCtx, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-e08e88b5.mjs').then((m) => m.default || m)
  },
  {
    name: "event-slug-inscription",
    path: "/event/:slug()/inscription",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-858e33fd.mjs').then((m) => m.default || m)
  },
  {
    name: "event-slug-thanks",
    path: "/event/:slug()/thanks",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d10997fe.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-585f402f.mjs').then((m) => m.default || m)
  },
  {
    name: "thanks",
    path: "/thanks",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/thanks-788cb95a.mjs').then((m) => m.default || m)
  }
];
...
const inscription_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
...
const layouts = {
  default: () => import('./_nuxt/default-20e4bbb1.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-68a92b0f.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRoute as a, useHead as b, createError as c, defineStore as d, entry$1 as default, useRouter as e, navigateTo as n, useSetting as u };
